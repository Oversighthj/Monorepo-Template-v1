...
class MessageApi {
  ...
  Future<Response<BuiltList<MessageDTO>>> messagesGet({ 
    int? bookingId,
    ...
    final _queryParameters = <String, dynamic>{
      if (bookingId != null) r'bookingId': encodeQueryParameter(_serializers, bookingId, const FullType(int)),
    };
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> messagesPost({ 
    ...
    try {
      const _type = FullType(MessageDTO);
      _bodyData = _serializers.serialize(messageDTO, specifiedType: _type);
