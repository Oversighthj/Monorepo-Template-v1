...
class TaskControllerIntegrationTest {
  ...
  void setUp() {
    ...
    // ---- property ----
    PropertyEntity prop = propertyRepo.save(new PropertyEntity(null, "Unit 1", "123 Main", owner));
  ...
  void filterByBookingIdReturnsOnlyBookingTasks() throws Exception {
    ...
    PropertyEntity prop2 =
        propertyRepo.save(new PropertyEntity(null, "Unit 2", "456 Other", guest2));
  ...
  void putUpdatesStatus() throws Exception {
    ...
    mockMvc
        .perform(
            put("/tasks/" + taskId).contentType(MediaType.APPLICATION_JSON).content(updateJson))
        .andExpect(status().isOk())
