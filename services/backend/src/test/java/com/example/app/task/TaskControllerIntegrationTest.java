 ...
 */
@SpringBootTest(classes = TemplateApplication.class)   // <- points to @SpringBootConfiguration
...
class TaskControllerIntegrationTest {
    ...
    void setUp() {
        ...
        // property
        PropertyEntity prop =
                propertyRepo.save(new PropertyEntity(null, "Unit 1", "123 Main", owner, true));
